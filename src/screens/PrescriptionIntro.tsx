  ...
  return (
    <div className="min-h-screen bg-white flex justify-center font-sans overflow-hidden">
      ...
      >
        ...
        >
          <video src={poriLoadingVideo} autoPlay muted playsInline style={{ width: '45vw', height: '45vw', maxWidth: '300px', maxHeight: '300px', objectFit: 'contain', display: 'block', background: 'transparent', clipPath: 'inset(4px 4px 6px 4px)' }} />
        </div>
